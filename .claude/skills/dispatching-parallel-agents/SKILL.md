...
Each agent gets precisely crafted instructions and context — **never your session's history**. This keeps agents focused and preserves your own context for coordination.
...
Group tasks by what's independently broken:
...
| No context: "Fix the race condition" | Include error messages and test names |
| No constraints | Add: "Do NOT change production code" |
